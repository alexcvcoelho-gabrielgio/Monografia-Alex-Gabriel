...
Juntamente com o modelo relacional foi criado a linguagem SQL, que mantinha um nível de abstração sobre os dados, além de criar relatórios detalhados sobre o cliente, satisfazendo as exigências crescentes dos negócios. Logo se começou a notar deficiências neste modelo, era caro manter este volume de dados crescente, e acessá-lo era lento, sem contar que haviam muitas duplicações de dados, para resolver este problema criou-se o modelo Entidade Relacionamento (ER), em que cada item era definido independentemente do seu uso, aumentando a usabilidade dos dados, modelo este que é muito bem aceito até os dias de hoje.%~\cite{leigos}
...
A figura ~\ref{fig:hadoopflow} mostra como o dado e capturado e entao processado no Hadoop, e os resultado usados no sistema de BI.~\cite{hadoopessentials}
